...
proto.hooks = {
  init: function () {
    ...
    addObserver.observe(this.doc.querySelector('#playerSongInfo'), {childList: true, subtree: true});
    shuffleObserver.observe(this.doc.querySelector('#player button[data-id="shuffle"]'), {attributes: true});
    repeatObserver.observe(this.doc.querySelector('#player button[data-id="repeat"]'), {attributes: true});
    playbackObserver.observe(this.doc.querySelector('#player button[data-id="play-pause"]'), {attributes: true});
    playbackTimeObserver.observe(this.doc.querySelector('#player #slider'), {attributes: true});
    ratingObserver.observe(this.doc.querySelector('#player .player-rating-container'), {attributes: true, subtree: true});
  }
};
